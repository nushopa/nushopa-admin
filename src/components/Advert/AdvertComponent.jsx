    ...
    <div>
      ...
      <div className="flex justify-between gap-3 mb-6">
        <button
          ...
          className="px-4 py-2 bg-mainGreen text-white font-semibold rounded-xl text-xs transition-all duration-200 hover:opacity-90"
        >
          Upload
        </button>
        ...
        <button
          ...
          className="px-8 py-3.5 border border-zinc-300 text-zinc-700 font-semibold rounded-xl text-xs hover:border-zinc-400 transition-all duration-200"
        >
          View All
        </button>
      </div>

      <div className="bg-white shadow-lg p-4 rounded-lg mb-3">
        {/* Loading */}
        {isLoading && (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          {adverts.map((advert) => (
            ...
            >
              {/* Image area with hover overlay scoped to just the image */}
