...
export function ProductTableList({ loading, products, onDelete, onEdit }) {
                ...
                <tr key={_id ?? index} className="cursor-pointer hover:bg-greenWhite hover">
                  ...
                  <td className={classes}>
                    <Tooltip content="Edit product">
                      <IconButton variant="text" onClick={() => onEdit(_id)}>
                        <PencilIcon className="h-4 w-4" />
                      </IconButton>
                    </Tooltip>
                    <Tooltip content="Delete product">
                      <IconButton variant="text" onClick={() => onDelete(_id)}>
